<template>
    <div id="applar">
        ...
        <app-footer/>
        <!-- end app vue -->
        <a id="calltrap-btn" class="b-calltrap-btn calltrap_offline hidden-phone visible-tablet" href="tel:0388162714">
        ...
        <div id="tu_facebook_messenger">
            ...
            <div class="fb-chat-box" style="display: none;">
                <div class="fb-page fb_iframe_widget" data-tabs="messages" data-href="https://www.facebook.com/pg/dongvu97/" data-width="300" data-height="400" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false" data-small-header="false" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=true&amp;container_width=298&amp;height=400&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2FVinCity.official%2F&amp;locale=vi_VN&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=false&amp;small_header=false&amp;tabs=messages&amp;width=300"><span style="vertical-align: bottom; width: 298px; height: 400px;"><iframe name="f56660af7608e4" width="300px" height="400px" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" title="fb:page Facebook Social Plugin" class=""></iframe></span>
                </div>
            </div>
        </div>
        <!-- menu bar -->
        <div class="icon-bar">
            ...
            <a href="https://mail.google.com/" class="google"><i class="fab fa-google"></i></a>
            <a href="https://www.linkedin.com/" class="linkedin"><i class="fab fa-linkedin"></i></a>
            <a href="https://youtube.com" class="youtube"><i class="fab fa-youtube"></i></a>
        </div>
        <!-- end menu bar -->
        <div id='menuMobileBar' style='display: none;'>
            <v-speed-dial style="margin-left: 20px;" v-model="fab" bottom="bottom" right="right" direction="top" :open-on-hover="true" transition="slide-y-reverse-transition">
